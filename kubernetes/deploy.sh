...
# Deploy GPU Monitoring Dashboard to Kubernetes
set -e
...
echo "  kubectl create job -n gpu-monitoring --from=cronjob/gpu-batch-analytics gpu-batch-analytics-manual-\$(date +%s)"
echo ""
